...
#include "pVFvPatchVectorField2Dpf_Port1.H"
...
pVFvPatchVectorField2Dpf_Port1::pVFvPatchVectorField2Dpf_Port1
(
    const fvPatch& p,
...
pVFvPatchVectorField2Dpf_Port1::pVFvPatchVectorField2Dpf_Port1
(
    const pVFvPatchVectorField2Dpf_Port1& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
	...
	z_(dict.lookup("z"))
{
    ...
    {
        FatalErrorIn("pVFvPatchVectorField2Dpf_Port1(dict)")
	...
	Info<< "This is the Port1 version !" << endl;
...
pVFvPatchVectorField2Dpf_Port1::pVFvPatchVectorField2Dpf_Port1
(
    const pVFvPatchVectorField2Dpf_Port1& fcvpvf,
    const DimensionedField<vector, volMesh>& iF
)
:
...
void pVFvPatchVectorField2Dpf_Port1::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    const vector ctr = vector(0, -20*R, 0);
...
// Write
void pVFvPatchVectorField2Dpf_Port1::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchVectorField, pVFvPatchVectorField2Dpf_Port1);
