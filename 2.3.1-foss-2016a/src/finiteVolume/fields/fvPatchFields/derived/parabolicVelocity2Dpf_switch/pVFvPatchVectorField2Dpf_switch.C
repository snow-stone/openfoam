...
#include "pVFvPatchVectorField2Dpf_switch.H"
...
pVFvPatchVectorField2Dpf_switch::pVFvPatchVectorField2Dpf_switch
(
    const fvPatch& p,
...
pVFvPatchVectorField2Dpf_switch::pVFvPatchVectorField2Dpf_switch
(
    const pVFvPatchVectorField2Dpf_switch& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
	...
	z_(dict.lookup("z"))
{
    ...
    {
        FatalErrorIn("pVFvPatchVectorField2Dpf_switch(dict)")
	...
	Info<<"turbulentSwitch version !" << endl;
...
pVFvPatchVectorField2Dpf_switch::pVFvPatchVectorField2Dpf_switch
(
    const pVFvPatchVectorField2Dpf_switch& fcvpvf,
    const DimensionedField<vector, volMesh>& iF
)
:
...
void pVFvPatchVectorField2Dpf_switch::updateCoeffs()
{
    if (updated())
    {
        return;
...
// Write
// very important For parallel computing. DecomposePar will call this to write to processor*
void pVFvPatchVectorField2Dpf_switch::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchVectorField, pVFvPatchVectorField2Dpf_switch);
